                                        ...
                                        <div className="row m-0">
                                            <div className="col-sm-12 sign-in-page-data">
                                                <div className="sign-in-from bg-primary rounded">
                                                    <h3 className="mb-0 text-center text-white">User Sign-in</h3>
                                                    <p className="text-center text-white">Enter your email address and password to access admin panel.</p>
                                                    <form className="mt-4 form-text" id="userlogin" onSubmit={(event) => handlelogin(event)}>
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <a href="#" className="float-right text-dark" onClick={forgotpassword}>Forgot password?</a>
                              ...
                              <div className="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                  ...
                                  <label className="custom-control-label" for="customCheck1">Remember Me</label>
                                                        ...
                                                        <div className="sign-info text-center">
                                                            <button onClick={handlelogin} type="button" className="btn btn-white d-block w-100 mb-2">Sign in</button>
                                                            <span className="text-dark dark-color d-inline-block line-height-2">Don't have an account? <Link className="nav-link"
                                                                to="/Userreg"><a className=" text-white">Sign up</a></Link></span>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
