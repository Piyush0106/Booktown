...
function Change_userpass() {
    ...
    function handlepassword(e) {
        ...
        axios.post('http://localhost:3001/user-change-password-action', formData)
            .then(res => {
    ...
    return (
        <>
            <Usersidebar />
            <Navbar />
            {/* <div className="container-md justify-content-center" id="uspasschange">
                            ...
                            <div className="row m-0">
                                <div className="col-sm-12 sign-in-page-data">
                                    <div className="sign-in-from bg-primary rounded">
                                        ...
                                        <form className="mt-4 form-text" id={"uspasschange"} onSubmit={(event) => handlepassword(event)}>
...
export default Change_userpass